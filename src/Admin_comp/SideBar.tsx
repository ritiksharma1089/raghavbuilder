...
const SideBar = () => {
  return (
   <div className="flex flex-col bg-white shadow-md w-[80px] md:w-[200px]  fix">
...
<div className="flex flex-col items-center   overflow-hidden text-gray-700  rounded ">
    ...
    <div className="w-full px-2">
      <div className="flex flex-col items-center w-full mt-3 border-t border-gray-700">
        ...
        className="flex items-center w-full h-12 px-4 mt-2 rounded hover:bg-gray-700 hover:text-gray-300" >
          <svg className="w-6 h-6 stroke-current" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
            stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
              d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
          </svg>
          <span className="ml-2 text-sm font-medium hidden md:block" > update</span>
        </Link>
              </div>
